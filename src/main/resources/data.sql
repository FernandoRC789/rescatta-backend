...
-- Razas de perro
INSERT IGNORE INTO breeds (name, species) VALUES ('Mestizo', 'PERRO');
INSERT IGNORE INTO breeds (name, species) VALUES ('Labrador Retriever', 'PERRO');
INSERT IGNORE INTO breeds (name, species) VALUES ('Pastor Alemán', 'PERRO');
INSERT IGNORE INTO breeds (name, species) VALUES ('Golden Retriever', 'PERRO');
INSERT IGNORE INTO breeds (name, species) VALUES ('Chihuahua', 'PERRO');
INSERT IGNORE INTO breeds (name, species) VALUES ('Criollo Peruano', 'PERRO');

-- Razas de gato
INSERT IGNORE INTO breeds (name, species) VALUES ('Mestizo', 'GATO');
INSERT IGNORE INTO breeds (name, species) VALUES ('Siamés', 'GATO');
INSERT IGNORE INTO breeds (name, species) VALUES ('Persa', 'GATO');
INSERT IGNORE INTO breeds (name, species) VALUES ('Angora', 'GATO');

-- Organizaciones (refugios/rescatistas) demo
INSERT IGNORE INTO organizations (name, verified, district) VALUES ('Refugio Esperanza', true, 'San Isidro, Lima');
INSERT IGNORE INTO organizations (name, verified, district) VALUES ('Rescate Miraflores', true, 'Miraflores, Lima');
...
-- Mascota 1
INSERT IGNORE INTO pet_temperament_tags (pet_id, tag, tag_order) VALUES (1, 'SOCIABLE', 0);
INSERT IGNORE INTO pet_temperament_tags (pet_id, tag, tag_order) VALUES (1, 'ACTIVO', 1);
INSERT IGNORE INTO pet_temperament_tags (pet_id, tag, tag_order) VALUES (1, 'APTO_NINOS', 2);
INSERT IGNORE INTO pet_temperament_tags (pet_id, tag, tag_order) VALUES (1, 'APTO_PERROS', 3);

-- Mascota 2
INSERT IGNORE INTO pet_temperament_tags (pet_id, tag, tag_order) VALUES (2, 'TIMIDO', 0);

-- Mascota 3
INSERT IGNORE INTO pet_temperament_tags (pet_id, tag, tag_order) VALUES (3, 'SOCIABLE', 0);
INSERT IGNORE INTO pet_temperament_tags (pet_id, tag, tag_order) VALUES (3, 'ACTIVO', 1);

-- Mascota 4
INSERT IGNORE INTO pet_temperament_tags (pet_id, tag, tag_order) VALUES (4, 'PROTECTOR', 0);
INSERT IGNORE INTO pet_temperament_tags (pet_id, tag, tag_order) VALUES (4, 'TRANQUILO', 1);

-- Fotos placeholder (reemplazar por URLs reales cuando se conecte el storage definitivo)
INSERT IGNORE INTO pet_photos (pet_id, url, photo_order) VALUES (1, '/uploads/seed/luna_1.jpg', 0);
INSERT IGNORE INTO pet_photos (pet_id, url, photo_order) VALUES (2, '/uploads/seed/max_1.jpg', 0);
INSERT IGNORE INTO pet_photos (pet_id, url, photo_order) VALUES (3, '/uploads/seed/michi_1.jpg', 0);
INSERT IGNORE INTO pet_photos (pet_id, url, photo_order) VALUES (4, '/uploads/seed/rocky_1.jpg', 0);

-- Un par de reportes de ejemplo (para probar /api/v1/reports/nearby y /api/v1/home/citizen-summary)
INSERT IGNORE INTO animal_reports (species, age_group, breed_id, animal_condition, description, latitude, longitude,
